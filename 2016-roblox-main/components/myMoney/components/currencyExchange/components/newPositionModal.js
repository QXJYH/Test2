...
const NewPositionModal = props => {
  ...
  return <OldModal title='Convert Currency'>
    <table className='w-100'>
      <tbody>
        <tr>
          <td className='text-end fw-bolder pe-2'>Type:</td>
          <td>
    ...
    <div className='row mt-4'>
      <div className='col-4 offset-2'>
        <ActionButton disabled={locked} className={btnStyles.buyButton} label='Convert' onClick={(e) => {
          setFeedback(null);
