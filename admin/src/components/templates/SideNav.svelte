<script lang="ts">
	...
	import { HomeIcon, UsersIcon, GiftIcon, BookOpenIcon, EyeIcon, PlusCircleIcon, EditIcon, FilePlusIcon, RefreshCcwIcon, UploadCloudIcon, CheckSquareIcon, TagIcon, SunriseIcon, FlagIcon, StarIcon, BookIcon, PhoneIcon, ActivityIcon, TabletIcon, ChevronDownIcon, ChevronRightIcon } from "svelte-feather-icons";
		...
		<div class="position-sticky pt-3">
			...
			<ul class="nav flex-column">
				...
				<li class="nav-item mt-2 d-md-none d-block">
					<a class="nav-link" href="/home">Back to ROBLOX</a>
				</li>
			</ul>
		</div>
	</nav>
