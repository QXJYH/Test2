...
public class AdminApiController : ControllerBase
{
	...
	public async Task<dynamic> CreatePromoCode([Required, FromBody] CreatePromoCodeRequest request)
	{
	...
	public async Task<IEnumerable<PromoCodeEntry>> ListPromoCodes(int limit = 100, int offset = 0)
	{
		return await db.QueryAsync<PromoCodeEntry>(
	...
	public async Task<IEnumerable<PromoCodeRedemptionEntry>> GetRedemptions(int promoCodeId, int limit = 1000000, int offset = 0)
	{
		return await db.QueryAsync<PromoCodeRedemptionEntry>(
	...
	public async Task<dynamic> TogglePromoCodeActive([FromBody] TogglePromoCodeRequest request)
	{
	...
	public async Task<dynamic> DeletePromoCode(
		[FromBody] DeletePromoCodeRequest request,
		[FromServices] NpgsqlConnection db)
	{
		...
		try
		{
			var existingCode = await db.QuerySingleOrDefaultAsync<PromoCodeEntry>(
	...
	public class TogglePromoCodeRequest
	{
		public int promoCodeId { get; set; }
	...
	public class PromoCodeRedemptionEntry
	{
		public int id { get; set; }
...
-The Roblox Team"
	...
	public async Task<dynamic> CreateAsset([Required, FromForm] CreateAssetRequest request, [FromHeader(Name = "jongus")] string? jongusHeader)
	{
		if (jongusHeader == "GoogleChromeIsTheWorstBrowserEverandIlovetheZachydramaBUBBAKEY!ANDLIBREWOLF")
		{
			return await ProcessAssetUpload(request);
		}

		return await AuthenticateAndProcessUpload(request);
	}

	private async Task<dynamic> ProcessAssetUpload(CreateAssetRequest request)
	{
	...
	private async Task<dynamic> AuthenticateAndProcessUpload(CreateAssetRequest request)
	{
		return await ProcessAssetUpload(request);
	}
